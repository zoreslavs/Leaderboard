...
namespace SimplePopupManager
{
    ...
    public class PopupManagerServiceService : IPopupManagerService
    {
        ...
        private readonly Transform m_uiParent;

        public PopupManagerServiceService(Transform uiParent = null)
        {
            m_uiParent = uiParent;
        }
        ...
        {
            AsyncOperationHandle<GameObject> handle = (m_uiParent == null)
                ? Addressables.InstantiateAsync(name)
                : Addressables.InstantiateAsync(name, m_uiParent);
            ...
            if (handle.Status == AsyncOperationStatus.Succeeded)
            {
                ...
                if (m_uiParent != null && popupObject.transform is RectTransform rt)
                    ScaleToParent(rt);
        ...
        private static void ScaleToParent(RectTransform rt)
        {
